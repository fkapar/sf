      ...
      <div class="container">
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h5><b>ABOUT SOCIAL FERN</b></h5>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-3">
              <!-- /.mailbox-controls -->
<div  style = "font-size:14px;">
<h6 style = "font-size:15px;"><b>DATA</b></h6>
<p>Social Fern compiles data from YouTube and uses the data to make statistical graphs and charts that track progress and growth. We include information such as estimated earnings and future projections, providing both numerical data and easy-to-read graphs. Statistics are freely available to anyone using our website. Social Fern currently tracks more then one million YouTube channels. Social Fern reaches over 10K unique visitors every month with a good portion of those users checking the site every day.</p>

<h6 style = "font-size:15px;"><b>INDUSTRY NEWS & COMMUNITY</b></h6>

<p>Social Fern operates a news blog that reports on the top stories in the digital media industry. We aim to bring you fast, timely updates on everything online video and social media, as well as full coverage of prominent events and breaking news.</p>

Social Fern also help foster a sense of community between our users through the use of our social media outlets, newsletters, and blog posts. We frequently highlight up-and-coming YouTube creators around our website and on our homepage. We attend industry events and host meet-ups in an effort to bring online communities to the third dimension.</p>

<h6 style = "font-size:15px;"><b>HISTORY</b></h6>
<p>Social Fern was officially incorporated in 2023</p>

<h6 style = "font-size:15px;"><b>FUTURE GOALS</b></h6>
<p>Social Fern is constantly looking towards the future, and how we can expand to report on more social media sites, provide better services to our users, and make data as accessible as possible.</p>

<p>We also strive to increase our reach through reporting more industry news on our blog and by forming business relationships with respected organizations such as YouTube</p>
              </div>
